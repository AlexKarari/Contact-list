...
def main():
    ...
    while True:
            print(
                "Use these short codes : cc - create a new contact, dc - display contacts, del- for delete, fc -find a contact, ex -exit the contact list ")
            ...
            if short_code == 'cc':
                    ...
                    print(f"{search_contact.first_name} has been deleted")
